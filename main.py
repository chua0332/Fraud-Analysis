...
model_in = open('/Users/eugenechua/Downloads/skillsfuture_interview/fraud/Fraud-Analysis/objects/XGB_classifier.pkl','rb')
XGBmodel = pickle.load(model_in)
preprocessor_in = open('/Users/eugenechua/Downloads/skillsfuture_interview/fraud/Fraud-Analysis/objects/preprocessor.pkl','rb')
